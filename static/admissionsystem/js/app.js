...
function generateMarkers(featureCollection) {
    ...
    featureCollection.forEach((feature) => {
        ...
        if (feature.geometry.type == "Point") {
            ...
            // classData = classData.split(","); // new data requires splitting on empty space
...
function makePopupContentMarker(feature) {
    ...
    console.log('Feature is: ', feature.geometry.coordinates)
    var lat = JSON.stringify(feature.geometry.coordinates[0]);
    var long = JSON.stringify(feature.geometry.coordinates[1]);
